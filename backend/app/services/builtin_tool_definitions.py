...
_BUILTIN_TOOL_SOURCE = [
    ...
    *_DEPLOY_BUILTIN_TOOL_DEFINITIONS,
    ...
    # ── Xiaohongshu (小红书) Operations Tools ──
    {
        "name": "xhs_search_notes",
        "display_name": "Search XHS Notes",
        "description": "Search Xiaohongshu (小红书) notes by keyword. Returns note listings with title, likes, comments. Use for market research, competitor analysis, and content inspiration.",
        "category": "xhs",
        "icon": "📕",
        "is_default": False,
        "parameters_schema": {
            ...
            "properties": {
                ...
                "sort_by": {"type": "string", "enum": ["general", "popularity", "time"], "description": "Sort order (default: general)"},
                "note_type": {"type": "string", "enum": ["normal", "video"], "description": "Filter by note type"},
            },
            "required": ["keyword"],
            "additionalProperties": False,
        },
    ...
    },
    {
        ...
        "display_name": "Generate XHS Content",
        "description": "Use AI to generate Xiaohongshu (小红书) content. Given a topic, generates title, body text, and hashtags in the platform's style. Optionally applies a persona for tone/style.",
        "category": "xhs",
        "icon": "✨",
        "is_default": False,
        "parameters_schema": {
            "type": "object",
            "properties": {
                "topic": {"type": "string", "description": "Content topic/theme to generate about"},
                "persona_id": {"type": "string", "description": "UUID of persona to apply for tone/style (optional)"},
                "account_id": {"type": "string", "description": "UUID of account to assign (optional)"},
                "tone": {"type": "string", "description": "Override tone: e.g. 'professional', 'casual', 'humorous'"},
                "extra_instructions": {"type": "string", "description": "Additional instructions for content generation"},
            },
            "required": ["topic"],
            "additionalProperties": False,
        },
    ...
    },
    {
        ...
        "display_name": "Publish to XHS",
        "description": "Publish a content draft to Xiaohongshu (小红书) via CDP browser automation. Requires Chrome with CDP enabled and logged in. Content must exist as a draft first.",
        "category": "xhs",
        "icon": "📤",
        "is_default": False,
        "parameters_schema": {
            "type": "object",
            "properties": {
                "content_id": {"type": "string", "description": "UUID of the content draft to publish"},
                "account_id": {"type": "string", "description": "UUID of the account to publish with (optional)"},
                "preview": {"type": "boolean", "description": "Preview mode — does not actually publish"},
            },
            "required": ["content_id"],
            "additionalProperties": False,
        },
    ...
    {
        "name": "xhs_manage_content",
        "display_name": "Manage XHS Content",
        "description": "CRUD operations for Xiaohongshu content. Create/update/delete drafts, list content with filters.",
        "category": "xhs",
        "icon": "📝",
        "is_default": False,
        "parameters_schema": {
            "type": "object",
            "properties": {
                "action": {"type": "string", "enum": ["list", "create", "update", "delete", "get"], "description": "CRUD action"},
                "content_id": {"type": "string", "description": "Content UUID (required for get/update/delete)"},
                "title": {"type": "string", "description": "Title (required for create, optional for update)"},
                "content": {"type": "string", "description": "Body text"},
                "tags": {"type": "array", "items": {"type": "string"}, "description": "Hashtag list"},
                "status": {"type": "string", "enum": ["draft", "scheduled", "published"], "description": "Filter or set status"},
    ...
    },
    {
        ...
        "display_name": "Get XHS Note Detail",
        "description": "Get detailed information about a Xiaohongshu note including content, images, comments, and engagement metrics.",
        "category": "xhs",
        "icon": "📋",
        "is_default": False,
        "parameters_schema": {
            ...
            "properties": {
                ...
                "xsec_token": {"type": "string", "description": "Security token from search results"},
            },
            "required": ["note_id"],
            "additionalProperties": False,
        },
    ...
    {
        "name": "xhs_interact_note",
        "display_name": "Interact with XHS Note",
        "description": "Like, bookmark, or comment on a Xiaohongshu note. Use for engagement and community building.",
        "category": "xhs",
        "icon": "💬",
        "is_default": False,
        "parameters_schema": {
            ...
            "properties": {
                "note_id": {"type": "string", "description": "Xiaohongshu note ID"},
                "action": {"type": "string", "enum": ["like", "bookmark", "comment"], "description": "Interaction type"},
    ...
    {
        "name": "xhs_get_analytics",
        "display_name": "Get XHS Analytics",
        "description": "Retrieve Xiaohongshu analytics data — overview metrics, per-note stats, or live data from the creator center.",
        "category": "xhs",
        "icon": "📊",
        "is_default": False,
        "parameters_schema": {
            "type": "object",
            "properties": {
                "type": {"type": "string", "enum": ["overview", "notes", "live"], "description": "Analytics type: overview (aggregated), notes (per-note), live (from creator center)"},
